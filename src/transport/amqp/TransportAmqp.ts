...
export class TransportAmqp extends Transport<ITransportAmqpSettings> {
    ...
    protected createQueueReplyName(): string {
        return this.prefixAdd(`${TransportAmqp.QUEUE_REPLY}.${this.uid}`);
    }

    protected createWaitQueueName(waitDelay: TransportCommandWaitDelay): string {
        return this.prefixAdd(`${TransportAmqp.QUEUE_WAIT}.${waitDelay}`);
    }

    protected createWaitExchangeName(waitDelay: TransportCommandWaitDelay): string {
        return this.prefixAdd(`${TransportAmqp.EXCHANGE_WAIT}.${waitDelay}`);
    }
    ...
    protected get deadExchangeName(): string {
        return this.prefixAdd(TransportAmqp.EXCHANGE_DEAD);
    }

    protected get eventExchangeName(): string {
        return this.prefixAdd(TransportAmqp.EXCHANGE_EVENT);
    }
